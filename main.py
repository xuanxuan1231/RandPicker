...
from PyQt6.QtGui import QColor, QMouseEvent, QIcon, QPixmap
...
class Widget(QWidget):
    ...
    def pick(self):
        ...
        # 设置头像
        avatar_path = f'./stu_photo/{student["id"]}.png'
        if os.path.exists(avatar_path):
            ...
            avatar.setStyleSheet('border-radius: 40px; background-color: transparent;')
        else:
            avatar.setStyleSheet('background-color: rgb(200, 200, 200); border-radius: 40px;')
        self.is_picking = False
